...
const Retrospectiva = () => {
  ...
  const porPagina = 5;
  const retrosPaginados = retros.slice(
    (pagina - 1) * porPagina,
    pagina * porPagina
  );
  ...
  useEffect(() => {
    ...
    fetch(
      ...
      .then(setRetros)
      .catch(() =>
        Swal.fire("Error", "No se pudieron cargar las retrospectivas", "error")
      );
  ...
  const saveEdit = async (id) => {
    try {
      ...
      Swal.fire(
        "Actualizado",
        "Retrospectiva actualizada correctamente",
        "success"
      );
    } catch (err) {
        ...
        <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-xl p-6 my-10">
          ...
          <div className="grid gap-4">
            ...
            <textarea
              ...
              onChange={(e) =>
                setForm({ ...form, puntos_buenos: e.target.value })
              }
              className="border px-3 py-2 rounded"
            />
            ...
            <textarea
              ...
              onChange={(e) =>
                setForm({ ...form, puntos_mejorar: e.target.value })
              }
              className="border px-3 py-2 rounded"
            />
            ...
            <textarea
              ...
              onChange={(e) =>
                setForm({ ...form, acciones_mejora: e.target.value })
              }
              className="border px-3 py-2 rounded"
            />
                      ...
                      {editId === r.id ? (
                        <textarea
                          ...
                          onChange={(e) =>
                            setEditData({
                              ...editData,
                              acciones_mejora: e.target.value,
                            })
                          }
                        />
                      ) : (
