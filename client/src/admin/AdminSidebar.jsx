      ...
      `}>
        ...
        <div>
          <div className="flex items-center justify-between mb-8">
            ...
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecarp="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
              </svg>
            </button>
          </div>
          ...
          <nav className="space-y-3">
            <Link 
              to="/admin/marco" 
              className={linkClass("/admin/marco")}
              onClick={closeSidebar}
            >
              Conoce el marco
            </Link>
            <Link 
              to="/admin/proyectos" 
              className={linkClass("/admin/proyectos")}
              onClick={closeSidebar}
            >
              Proyectos educativos
            </Link>
            <Link 
              to="/admin/asignar-grados" 
            ...
            <Link 
              ...
              className={linkClass("/admin/crear-cuenta")}
              onClick={closeSidebar}
            >
              Crear cuentas
            </Link>
            <Link 
              to="/admin/editar-usuarios" 
              className={linkClass("/admin/editar-usuarios")}
              onClick={closeSidebar}
            >
              Editar usuarios
            </Link>
            <Link 
              to="/admin/reportes" 
              className={linkClass("/admin/reportes")}
              onClick={closeSidebar}
            >
              Reportes
            </Link>
